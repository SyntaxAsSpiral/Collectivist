...
❗NOTE - current implementation is repo-specific seed and needs to be generalized as part of the seed-to-trunk architecture for other collection types. 

## Architecture

```
.repos/
├── .collectivist/                  # Repository collection seed
...
- **Seed architecture**: Repository-specific implementation of the broader seed-to-trunk pattern
...
- `.collectivist` - repository seed (meta-layer, compilation artifact)
